...
export default function CTe() {
  ...
  const handleEdit = (documento: CTeDocumento) => {
    ...
    setFormData({
      ...
      // VALORES FINANCEIROS
      valor_prestacao: documento.valor_prestacao?.toString() || '',
      valor_receber: documento.valor_receber?.toString() || '',
      valor_tributos: documento.valor_tributos?.toString() || '',
      valor_pedagio: documento.valor_pedagio?.toString() || '',
      valor_seguro: documento.valor_seguro?.toString() || '',
      icms_situacao_tributaria: documento.icms_situacao_tributaria || '',
      icms_bc_valor: documento.icms_bc_valor?.toString() || '',
      icms_aliquota: documento.icms_aliquota?.toString() || '',
      icms_valor: documento.icms_valor?.toString() || '',
      // DADOS FISCAIS
      cfop: documento.cfop || '',
      finalidade_cte: documento.finalidade_cte || '',
      tipo_servico: documento.tipo_servico || '',
      // DADOS DA CARGA
      valor_carga: documento.valor_carga?.toString() || '',
      quantidade_carga: documento.quantidade_carga?.toString() || '',
